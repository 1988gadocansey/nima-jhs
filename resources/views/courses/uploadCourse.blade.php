...
@if(Session::has('success'))
 ...
 <div align="center">
     <a href="{{ URL::to('courseDownloadExcel/xlsx') }}">   <button class="md-btn md-btn-small md-btn-success uk-margin-small-top">Download sample (Excel 2010-- format) </button></a>
     <a href="{{ URL::to('courseDownloadExcel/xls') }}">   <button class="md-btn md-btn-small md-btn-primary uk-margin-small-top">Download sample (Excel 97-2007 format)</button></a>
