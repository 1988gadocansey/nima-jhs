...
@endif
 ...
 <div align="center">
  <h5 class="uk-heading_c">Search student here - Report Card Printing </h5>
                     ...
                     <div class="uk-form-row">
                         <div class="uk-grid" data-uk-grid-margin>
                             <div class="uk-width-1-1">
                                 ...
                                 <input type="text" value="" id="q" class="md-input md-input-success" required="" name="q" placeholder="begin typing student here... " v-model="q" v-form-ctrl=""/>
                             </div>
