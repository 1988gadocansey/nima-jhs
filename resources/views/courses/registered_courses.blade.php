      ...
      <tbody>
                                        ...
                                        <tr align="">
                                           ...
                                           <td> {{ @$row->REGISTERED }}</td>
                                            <td> 
                                                <a onclick="return MM_openBrWindow('{{url("enter_mark/$row->id/course/$row->course/code")}}','mark','width=800,height=500')" ><i title='Click to enter mark' class="md-icon material-icons">edit</i>View/Enter Marks</a>
