                                ...
                                <div class="uk-grid uk-grid-width-medium-1-2 uk-grid-width-large-1-4" data-uk-grid-margin>
                                   ...
                                   <div class=" parsley-row">
                                        <div class="uk-input-group">
                                            ...
                                            <p></p>
                                            {{ Form::select('level', array(''=>'select level','1/2'=>'50', '1'=>'1st year','2'=>'2nd year','3'=>'3rd year' ,'400/1'=>'BTECH level 1','400/2'=>'BTECH level 2'), null, ["required"=>"required",'class' => 'md-input','v-model'=>'level','v-form-ctrl'=>'','v-select'=>'']) }}
