...
<h5 class="heading_b uk-margin-bottom">Edit Staff  data</h5>
                            ...
                            <div data-uk-grid-margin="" class="uk-grid uk-grid-width-medium-1-4 uk-grid-width-large-1-4">
                                ...
                                <div class="parsley-row">
                                    <div class="uk-input-group">
                                        ...
                                        <p class="uk-text-danger uk-text-small"  v-if="memberForm.title.$error.required">Title is required</p>                                        
                                    </div>
                                </div>
               ...
               <div data-uk-grid-margin="" class="uk-grid uk-grid-width-medium-1-4 uk-grid-width-large-1-4">
                                <div class="parsley-row"  >
                                    ...
                                    <span class="md-input-bar"></span>
                                      ...
                                      <p class="uk-text-danger uk-text-small"  v-if="memberForm.religion.$error.required">Religion is required</p>                                        
                                  </div>
                              </div>
                     ...
                     <div class="parsley-row">
                                    ...
                                    <div class="uk-input-group">
                                        ...
                                        <div class="md-input-wrapper md-input-filled"><label for="wizard_referer">SSNIT N<u>o</u>:</label><input type="text" id="ssnit" name="ssnit" class="md-input"        v-model="ssnit"  v-form-ctrl><span class="md-input-bar"></span></div>                
                                       </div>
                                </div>
                        ...
                        <div class="parsley-row">
                                    ...
                                    <div class="uk-input-group">
                                        ...
                                        <div class="md-input-wrapper md-input-filled"><label for="wizard_referer">Next of Kin Phone N<u>o</u> :</label><input type="text" id="kphone" name="kphone" class="md-input" data-parsley-type="digits" minlength="10"    maxlength="10" value="{{$data->kinPhone}}"  pattern='^[0-9]{10}$'  v-model="kphone"  v-form-ctrl><span class="md-input-bar"></span></div>                
                                        </div>
                                </div>
                             ...
                             <div data-uk-grid-margin="" class="uk-grid uk-grid-width-medium-1-4 uk-grid-width-large-1-4">
                                 ...
                                 <div class="parsley-row">
                                    <div class="uk-input-group">
                                        ...
                                        <div class="md-input-wrapper md-input-filled">
                                            {!!   Form::select('krelation',array("MOTHER"=>"Mother",'FATHER'=>"Father","HUSBAND"=>"Husband","WIFE"=>"Wife","SISTER"=>"Sister","BROTHER"=>"Brother","CHILD"=>"Child"),old('krelation',''),array('placeholder'=>'Select relationship',"required"=>"required","class"=>"md-input","v-model"=>"krelation","v-form-ctrl"=>"","v-select"=>"krelation"))  !!}
                                            <span class="md-input-bar"></span>
                                        </div>    
                                        <p class="uk-text-danger uk-text-small"  v-if="memberForm.krelation.$error.required">Relationship is required</p>                                        
                                    </div>
                                </div>
     ...
     <div data-uk-grid-margin="" class="uk-grid uk-grid-width-medium-1-4 uk-grid-width-large-1-4">
                                ...
                                <div class="parsley-row">
                                    ...
                                    <div class="uk-input-group">
                                        ...
                                        <div class="md-input-wrapper md-input-filled">
                                            {!!   Form::select('leave',array("AT POST"=>"At Post",'ON LEAVE'=>"On Leave"),old('leave',''),array('placeholder'=>'Select leave status',"class"=>"md-input","v-model"=>"leave","v-form-ctrl"=>"","v-select"=>"leave"))  !!}
                                            <span class="md-input-bar"></span>
                                        </div>    
                                         </div>
                                </div>
         ...
         <input type="hidden" name="id" value="{{$data->id}}"/>
          <div class="parsley-row">
                                    <div class="uk-input-group">
                                        ...
                                        <div class="md-input-wrapper md-input-filled"><label for="wizard_email">Grade</label><input type="text" id="grade" name="grade" class="md-input"   v-model="grade"v-form-ctrl  ><span class="md-input-bar"></span></div>                                            
        ...
        <div data-uk-grid-margin="" class="uk-grid uk-grid-width-medium-1-4 uk-grid-width-large-1-4">
                                ...
                                <div class="parsley-row">
                                    <div class="uk-input-group">
                                        ...
                                        <div class="md-input-wrapper md-input-filled"><label for="wizard_email">Designation :</label><input type="text" id="designation" title="work assigned to this staff" name="designation" class="md-input"   v-model="designation"v-form-ctrl  ><span class="md-input-bar"></span></div>                                            
...
<div class="actions clearfix "  >
    <ul aria-label="Pagination" role="menu">
        ...
        <li class="button_finish "    aria-hidden="true"  v-show="memberForm.$valid && in_payment_section==true"  >
         ...
         <button  v-show="memberForm.$valid"  class="md-btn md-btn-primary uk-margin-small-top client"  name="submit_order"  v-on:click="submit_form" type="button">Save</button>
        </li>
    </ul>
</div>
</div>
...
dependents:"{{$data->dependentsNo}}",
leave:"{{$data->leaves}}",
category:"{{$data->empStatus}}",
email:"{{$data->email}}",
education:"{{$data->education}}",
kname:"{{$data->kinName}}",
kaddress:"{{$data->kinAddress}}",
kphone:"{{$data->kinPhone}}",
krelation:"{{$data->kinRelation}}",
 options: [      
    ],
