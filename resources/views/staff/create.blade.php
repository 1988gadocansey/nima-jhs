...
<div class="actions clearfix "  >
    <ul aria-label="Pagination" role="menu">
        ...
        <li class="button_finish "    aria-hidden="true"  v-show="memberForm.$valid && in_payment_section==true"  >
            ...
            <button  v-show="memberForm.$valid"  class="md-btn md-btn-primary uk-margin-small-top clientm"  name="submit_order"  v-on:click="submit_form" type="submit">Save</button>
        </li>
    </ul>
</div>
</div>
