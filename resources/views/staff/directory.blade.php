                ...
                <div class="uk-vertical-align">
                    <div class="uk-vertical-align-middle">
                        <ul id="contact_list_filter" class="uk-subnav uk-subnav-pill uk-margin-remove">
                            ...
                            <li data-uk-filter="schamberger plc"><a href="#">Directors Office </a></li>
        ...
        <div class="md-card md-card-hover">
            <div class="md-card-head">
                ...
                <div class="uk-text-center">
                    <img class="md-card-head-avatar" src="{!!url('public/albums/staff/'.$row->emp_number.'.jpg')!!}" alt=""/>
                </div>
                <h3 class="md-card-head-text uk-text-center">
                    {{$row->name}} <span class="uk-text-truncate"> {{$row->emp_number}}</span>
                </h3>
            </div>
            <div class="md-card-content">
                <ul class="md-list">
                    <li>
                        <div class="md-list-content">
                            ...
                            <span class="uk-text-small uk-text-muted">An employee in {{@$row->departments->name}}</span>
                        </div>
                    </li>
                    <li>
                        <div class="md-list-content">
